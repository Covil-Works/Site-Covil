...
- O container principal acompanha o cabeçalho recolhido: min(calc(100% - 32px), 1120px). O espaçamento padrão entre seções é 80px, aplicado por padding de topo; não somar margens extras entre seções.
