...
const SOLUTION_REGISTRY = {
  splitup: {
    ...
    externalUrl: "https://play.google.com/store/apps/details?id=com.covildev.splitup&pcampaignid=web_share",
    ctaLabel: "Conhecer no Google Play ↗",
  },
  mywl: {
    name: "MyWL",
    ...
    externalUrl: "https://mywl.covildev.com",
    ctaLabel: "Acessar o MyWL ↗",
  },
};
